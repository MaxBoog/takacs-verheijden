            ...
            <div class="container padding-y footer">
                <div class="row justify-content-start">
                    <div class="col-lg-4">
                        ...
                        <p><i class="fas fa-chevron-right text-color-secondary"></i><a class="ps-2" href="/assets/docs/Algmene voorwaarden Takacs& Verheijden B.V. .pdf">Terms of Service</a></p>
                        <p><i class="fas fa-chevron-right text-color-secondary"></i><a class="ps-2" href="/assets/docs/Klachtenregeling Takacs & Verheijden.pdf">Complaints</a></p>
                        <p><i class="fas fa-chevron-right text-color-secondary"></i><a class="ps-2" href="/assets/docs/Privacyverklaring.pdf">Privacy statement</a></p>
                    </div>
                    <div class="col-lg-4">
                        <h3 class="font-secondary pt-5 pt-md-0">Sitemap</h3>
                        <p><i class="fas fa-chevron-right text-color-secondary"></i><a class="ps-2" href="/en/index.html">Home</a></p>
                        <p><i class="fas fa-chevron-right text-color-secondary"></i><a class="ps-2" href="/en/leadership.html">Academic Leadership</a></p>
                        <p><i class="fas fa-chevron-right text-color-secondary"></i><a class="ps-2" href="/en/about-us.html">About Us</a></p>
                        <p><i class="fas fa-chevron-right text-color-secondary"></i><a class="ps-2" href="/en/contact.html">Contact</a></p>
